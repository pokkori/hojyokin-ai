  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "IT導入補助金2026はいくらもらえますか？",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "通常枠で補助率1/2・上限150万円、デジタル化基盤導入類型では最大350万円です。AIが貴社に適した補助金を検索して申請書の下書きを生成します。"
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "事業計画書・見積書・決算書等の準備が必要ですが、このAIが申請書の下書きを自動生成するため、作業負担を大幅に削減できます。"
          }
        },
        {
          "@type": "Question",
          "name": "補助金を受けるまでの期間はどのくらいかかりますか？",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "申請〜採択通知まで2〜3ヶ月、交付決定まで1ヶ月、事業実施期間は6〜12ヶ月が一般的です。AIが期間・スケジュールを可視化します。"
          }
        },
      ],
    },
